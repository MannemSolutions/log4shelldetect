...
./log4shelldetect -modversion -hash -mod log4j/core/lookup/JndiLookup.class -mod META-INF/maven/org.apache.logging.log4j/log4j-core/pom.properties test/ > "$TMPFILE"
